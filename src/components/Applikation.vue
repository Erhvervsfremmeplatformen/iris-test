                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-xl-7">
                        ...
                        <apexchart v-if="response[currentSection]" type="radar" :options="radarOptions()" height="400" :series="radarData()"></apexchart>
                      </div>
                      <div class="col-xl-5">
    ...
    <section slot="pdf-content">
      ...
      <table class="table table--borderless table--blue" style="margin-top: 100px">
        <tr >
          <td>
            <p class="h6">Del 1</p>
        <h2 class="h4 mt-0">Hvordan er presset på jeres forretningsmodel?</h2>
        <p>Testen viser, hvor I oplever forandringer i jeres forretningsbetingelser, der kan indebære et behov for at styrke eller retænke forretningsmodellen.</p>
<figure class="figure p-5">
      ...
      <section class="pdf-item">
        ...
        <h2 class="h4 mt-0">Del 1: Hvordan er presset på jeres forretningsmodel?</h2>
        <hr />
...
<div v-if="response['test2']">
      ...
      <section class="pdf-item">
        ...
        <p>
          Nedenfor finder du et overblik over hvordan presset på din virksomhed er, sammen med et gennemsnit af hvordan andre virksomheder inden for
          samme branche klarer sig.
        </p>
        <hr />
        <h3 class="h6">{{ sections[0].resultPrimaryHeadline }}</h3>
        <p class="form-hint">Skala på 1-10, hvor 1 er lille/intet pres og 10 er stort pres</p>
...
export default {
  ...
  provide() {
  //   // Gør variabler tilgængelig for underkomponenter (uanset dybde), som kan bruges til at sørge for Vuex getters er reaktive.
  //   const sections = [] as any;
  //   Object.defineProperty(sections, 'value', {
  //     enumerable: false,
  //     get: () => this.sections
  //   });
  //   const values = {} as any;
  ...
  //   Object.defineProperty(currentSection, 'value', {
  //     enumerable: false,
            ...
            },
            {
              ...
              questions: [
                ...
                },
                {
                  ...
                  label: 'Der er et stort potentiale i vores branche/forsyningskæde for omstilling i retning af cirkulære principper eller lavere CO2-aftryk',
                  options: this.defaultOptions
                },
                {
          ...
          steps: [
            ...
            },
            {
              ...
              questions: [
                {
                  name: 'value1',
                  label: 'Vi har behov for at blive klarere på, hvordan vi skal differentiere os fra vores konkurrenter (fx med hensyn til design, services og pris)',
                  options: this.defaultOptions
                },
                {
                  name: 'value2',
...
generateReport() {
      ...
      await html2pdf()
        ...
        .then((pdf: any) => {
          ...
          for (let i = 1; i <= totalPages; i++) {
            ...
            pdf.text(i + '   /   ' + totalPages, pageWidth - 20, pageHeight - 15);
      ...
      Promise.all([...requests])
        .then((rsp: any) => {
          ...
          if (!rsp[0].data.error) {
            ...
            console.log('log3', this.response[this.currentSection]);
    ...
    handlePdfClick() {
        this.$refs.irispdf.generateReport();
    },
    ...
    emitFritekstEvent() {
     ...
     columnData() {
      ...
      console.log('log2', this.currentSection);
      console.log('log3', this.response[this.currentSection]);
