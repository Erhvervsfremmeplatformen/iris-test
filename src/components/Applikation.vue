        ...
        <div v-for="(section, sectionIndex) of sections" v-else :key="sectionIndex" class="col-lg-12">
          <template v-if="currentSection === section.id">
            <div class="row">
              ...
              <div v-if="currentStep !== section.steps.length" :class="['testclass mb-7', currentStep === 0 ? 'col-lg-7' : 'col-lg-9']">
                <button
                ...
                <div :class="`${currentSection === 'test1' ? 'bg-normal' : ''} full-width mt-3 p-md-7`">
                  ...
                  <div v-else-if="currentSection === 'test2'" class="container">
                    <div class="row">
                      ...
                      <div class="col-xl-7">
                        ...
                        <div class="card card-blue">
                          ...
                          <div class="card-footer pb-4 px-4 pb-md-7 px-md-7">
                            <button class="button button-primary">Kontakt dit regionale Erhvervshus</button>
                          </div>
                        </div>
                        <div class="card card-blue">
                          ...
                          <div class="card-footer pb-4 px-4 pb-md-7 px-md-7">
                            <button class="button button-primary" @click.prevent="generateReport()">
                              <svg class="icon-svg" focusable="false" aria-hidden="true">
                                <use xlink:href="#file-download"></use></svg
                              >Download resultatet som PDF
                            </button>
                      ...
                      <div class="offset-lg-1 col-md-4 hoejre-spalte-ydelse pr-0">
                        <div class="card card-border">
                          ...
                          <div class="card-footer card-action">
                            <div class="action-buttons">
                              <div><button class="mb-4 button button-secondary" @click.prevent="">Kontakt dit regionale erhvervshus</button></div>
                              <div>
                                <a href="" class=""
        ...
        <section slot="pdf-content">
          ...
          <section class="pdf-item">
            ...
            <div>
              ...
              <apexchart v-if="response['test1']" type="radar" :options="radarOptions('test1', true)" width="600px" :series="radarData()"></apexchart>
            ...
            <div>
              ...
              <ol v-if="response['test2']" class="suggestion-list">
                <li v-for="(link, index) of response[currentSection].suggestions.slice(0, 4)" :key="link.theme ? link.theme : index">
                  <div>
                    <p class="h4 m-0">{{ link.title ? link.title : '' }}</p>
                    <p class="mt-2">{{ link.description ? link.description : '' }}</p>
                    <a :href="link.linkUrl ? link.linkUrl : index"
                  ...
                  <tbody v-for="(section, sectionIndex) of sectionGroup.sections" :key="sectionIndex">
                    <tr v-if="section.headline" class="">
                      ...
                      <td class="h6 align-text-center">
                        <CircledAverage
                          :percentage="(calculateSectionAverage(section, values) / 10) * 100"
                          :value="calculateSectionAverage(section, values)"
                        />
                      </td>
                    </tr>
          ...
          <section class="pdf-item">
            <div
              v-for="(sectionGroup, sectionGroupIndex) of [
                { sections: sections[0].steps.slice(1, 4), headline: 'Del 1 - ' + sections[0].headline },
                { sections: sections[0].steps.slice(4, 6), headline: 'Del 1 - ' + sections[0].headline + ' - fortsat' },
                { sections: sections[1].steps.slice(1, 5), headline: 'Del 2 - ' + sections[1].headline },
                { sections: sections[1].steps.slice(5, 9), headline: 'Del 2 - ' + sections[1].headline + ' - fortsat' }
              ]"
              :key="sectionGroupIndex"
            >
              <p class="h6">Bilag</p>
...
export default {
  ...
  methods: {
    ...
    calculateSectionAverage(section: any, values: any) {
      let sum = 0;
      let average = 0 as number;
      section.questions.forEach((question: any) => {
        sum += values[question.name];
      });
      average = sum / section.questions.length;
      return average.toLocaleString('da-DK', { minimumFractionDigits: 1, maximumFractionDigits: 1 });
    }
  },
